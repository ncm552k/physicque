...
food_dict = {
    ...
    63: ['Pate', 10, 'g', 2, 10, 32.6, 1.08, 2.46, 1.54],
    ...
    71: ['Ngô', 50, 'g', 2, 10, 43, 1.63, 9.35, 0.65],
    72: ['Bưởi', 50, 'g', 2, 10, 16.5, 0.35, 4.2, 0.05], 
    73: ['Đậu phộng', 10, 'g', 2, 10, 57, 2.51, 2.1, 4.8],
    74: ['Mật ong', 1, 'thìa canh', 1, 4, 45.6, 0.045, 12.36, 0]
}


advices={
    1: "Nạp lượng calo cao hơn mức cơ thể cần để duy trì 10-20%",
    2: "Ăn nhiều hơn nhưng không nạp các loại thực phẩm kém lành mạnh.",
    3: "Ăn đa dạng nhiều loại thực phẩm và đảm bảo đủ 4 nhóm: chất bột, chất đạm, chất béo, vitamin và muối khoáng.",
    4: "Hạn chế uống rượu bia, nước có ga và ăn, uống đồ ngọt.",
    5: "Tỷ lệ dinh dưỡng cho protein-carb-fat là 35-45-20",

    6: "Giảm mức tiêu thụ calo 10% so với mức duy trì",
    7: "Lượng calo cắt giảm tập trung vào carb",
    8: "Tỷ lệ dinh dưỡng cho protein-carb-fat là 50-30-20",
    9: "Giảm mức tiêu thụ calo 20% so với mức duy trì",
    10: "Tỷ lệ dinh dưỡng cho protein-carb-fat là 55-20-25",

    11: "Giảm mức tiêu thụ calo 20% so với mức duy trì ở 5 ngày đầu với tỷ lệ dinh dưỡng cho protein-carb-fat là 50-30-20",
    12: "Tăng lượng nước nạp vào từ 1.5-2 lít ở 5 ngày đầu",
    13: "2 ngày trước thi đấu lượng, tăng lượng calo tiêu thụ lên 30% so với mức duy trì chủ yếu là carb: 30-60-10 protein-carb-fat",
    14: "Giảm lượng nước nạp vào từ 2-3 ngày trước khi lên sàn giảm còn 400-500ml trên ngày",
    15: "Tránh các bài tập nặng để duy trì được hình thể hiện tại",

    16: "Tránh các chấn thương để quá trình hồi phục cơ diễn ra được tốt",
    17: "Vận động và tập các bài tập nhẹ",
    18: "Tăng lượng calo nạp vào 10% so với mức duy trì hiện tại",
    19: "Tỷ lệ dinh dưỡng cho protein-carb-fat là 35-45-20",
    20: "Ưu tiên các thực phẩm giàu carb vào fat",
    
    21: "Nạp lượng calo đúng với mức duy trì",
    22: "Tỷ lệ dinh dưỡng cho protein-carb-fat là 40-40-20",
    23: "Nạp đầy đủ nước",
...
cutting1 = {
    ...
    "advices":[6,7,8,4,23],
    "meals":{
        1:[[5,45],[1,43,47],[1,45],[46,3],[1,52]],
        2:[[55,29],[25,56],[20,55],[13,23]],
        3:[[3,34],[2,37],[8,38],[9,35,47],[3,43]],
        4:[[11,57,23],[11,20],[11,23],[11,56]],
        5:[[8,41],[3,38],[9,33,47],[7,33],[8,42]],
    }
}
...
cutting2 = {
    ...
    "advices":[9,10,8,4,23],
    "meals":{
        1:[[5,45],[1,43],[1,45],[46,3],[1,52]],
        2:[[55,29],[25,56],[20,55],[13,23]],
        3:[[3,34],[2,37],[8,38],[9,35],[3,43]],
        4:[[11,57,23],[11,20],[11,23],[11,56]],
        5:[[8,41],[3,38],[9,33],[7,33],[8,42]],
    }
}
...
maintaince = {
    ...
    "meals":{
        ...
        2: [[69, 16, 21], [1, 23, 11], [45, 15, 60],[59,22]],
