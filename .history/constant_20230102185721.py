...
maintaince = {
    ...
    "advices":[1,2],
    "meals":{
        1: [[45, 17, 20], [id bánh mì nguyên cám, 12, 16, 22], [59, 53, 5],[51, id pate,53]],
        2: [[78, 16, 21], [1, 23, 11], [45, 15, 60],[59,22]],
        3: [[47,id bò băm(80:20), 33,24], [50, 4, 32,55], [48, 7, 34,21]],
        4: [[1, 13,], [59, 20, 12], [15, 29,],[18,11]],
        5: [[47, 9, 42,25], [50, id bò băm(80:20), 39,53], [48, 3, 19,id dầu ôliu],[47,8,40,44]],
    }
}
